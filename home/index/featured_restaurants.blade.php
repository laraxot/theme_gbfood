		...
		<div class="row">
			<div class="col-sm-4">
				<div class="title-block pull-left">
					...
					<h4>@lang($view.'.featured_restaurants.featured')</h4>
				</div>
			</div>
			<div class="col-sm-8">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-3 add-title">
						<h4>@lang($view.'.featured_restaurants.add_restaurant')</h4> </div>
					<div class="col-xs-12 col-sm-5 join-text">
						<p>@lang($view.'.featured_restaurants.add_restaurant_text')<a href="{{ asset($lang.'/restaurant') }}"><strong>@lang($view.'.featured_restaurants.directory')</strong></a> </p>
					</div>
					<div class="col-xs-12 col-sm-4 join-btn text-xs-right"><a href="{{ asset($lang.'/restaurant/create') }}" class="btn theme-btn btn-lg">@lang($view.'.featured_restaurants.i_am_restaurant')</a> </div>
				</div>
			</div>
		</section>
		<!-- add restaurant ends -->
