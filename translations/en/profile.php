...
$def = [
    ...
    'title' => 'Welcome to Foodtribù',
    'subtitle' => 'the most innovative food service platform',
    'question1' => 'What can I do as a registered user?',
...
Rai Advertising (Rai Pubblicità S.p.A.)
...
Yandex Metrica is a statistical and heat mapping service provided by YANDEX, LLC. Yandex Metrica can be used to identify which areas of a page are the object of the cursor passing or clicking the mouse so as to detect which of them attract the most interest.',
        'prv-flag_2_help' => '',
        'prv-flag_3' => ' ',
...
This service allows this Application to connect with the User\'s account on the Twitter social network, provided by Twitter, Inc.',
        'prv-flag_3_help' => '',
        'mandatoryPrivacy' => '* Mandatory selection',
    ],
];
...
$def['edit']['consCheckbox_0_title'] = 'Activity covered by the treatment';
$def['edit']['consCheckbox_1_title'] = 'Remarketing activity';
$def['edit']['consCheckbox_2_title'] = 'Site statistics activity';
$def['edit']['consCheckbox_3_title'] = 'Social Network';

$def['create'] = [
    'already_registered' => 'If you already have an account click here',
    'to_be_registered' => 'If you are not registered yet, click here.',
    ...
    'mandatoryPrivacy' => '* Mandatory selection',
    'consCheckbox_0_title' => 'Activity covered by the treatment',
    'consCheckbox_1_title' => 'Remarketing activity',
    'consCheckbox_2_title' => 'Site statistics activity',
    'consCheckbox_3_title' => 'Social Network',
    'firstname' => 'Name',
    'firstname_placeholder' => 'Ex. Mario',
    'firstname_help' => 'your first name',
    'email' => 'E-mail of your business',
    'email_help' => 'Ex. info@example.com',
    'email_placeholder' => 'info@example.com',
    'surname' => 'Surname',
    'surname_placeholder' => 'Ex. Rossi',
    'surname_help' => 'your first name',
    'handle' => 'Username',
    ...
    'question1' => 'Why do I need to register to order?',
    'answer1' => 'By registering you will give FoodTribù a way to help you order quickly and intuitively',
    'question2' => 'Does the service have a cost?',
...
$def['create']['field']['passwd_help'] = 'your secret password';
