...
$def = [
    ...
    'subtitle' => 'Free today and always',
    ...
    'question1' => 'Why register?',
    'answer1' => 'Foodtribù grants you thousands of new customers, you\'ll have more bookings, latest-generation technologies, advertising and a chatbot service.',
    'question2' => 'What are the benefits?',
    'answer2' => 'Foodtribù grows your business, Analysis of performance, control in every aspect thanks to a technology that is easy to use to avoid wasting time.',

    'cuisine' => [
        'title' => 'Dishes category',
        'title_placeholder' => 'Dishes category',
        'title_help' => 'ex. classic pizzas, appetizers',
        'choose' => 'Choose Dish Category',
    ],
    'cuisineCat' => [
        'title' => 'Type of Kitchen',
        'title_placeholder' => 'Type of Kitchen',
        'title_help' => 'ex. Meat, Fish, Pizza',
        'choose' => 'Choose Type Kitchen',
    ],
    'edit' => [
        'cuisineCat' => [
            'title' => 'Type of Kitchen',
    ...
    'bio' => '2 sentences about you',
    'bio_placeholder' => 'Ex. the passion of the kitchen is born ..',
    'bio_help' => 'your brief description',
    'passwd' => 'Password',
    'passwd_placeholder' => 'Password',
    'passwd_help' => 'Your secret password',
    'passwd_confirmation' => 'Repeat the password',
    'passwd_confirmation_placeholder' => 'Repeat the password',
    'passwd_confirmation_help' => 'Repeat your secret password',
    'submit' => 'Sign in',
    'create' => [
        'user' => [
        ...
        'restaurant' => [
            'title' => 'Register is fast, easy, and free.',
        ],
    ],
    'consCheckbox_0' => 'I have read and authorize the processing of data in accordance with the privacy policy *',
    'consCheckbox_1' => 'I have reviewed the Remarketing activities and authorize the treatment',
    'consCheckbox_2' => 'I have reviewed the activity of Statistics',
    'consCheckbox_3' => 'I have reviewed the activities regarding Facebook and social networks',
    'prv-doc' => ' ',
    'prv-doc_placeholder' => 'Information on the protection of personal data pursuant to art. 12 and 13 of Regulation (EU) 2016/679 of the European Parliament and Council of 27 April 2016.
...
By registering with the mailing list or the newsletter, the User\'s email address is automatically added to a list of contacts to which email messages containing information, including commercial and promotional information, relating to this Application may be transmitted. ',
    'prv-flag_1_help' => '',
    'prv-flag_2' => ' ',
    'prv-flag_2_placeholder' => 'The services contained in this section allow the Data Controller to monitor and analyze traffic data and are used to keep track of User behavior.
...
This service allows this Application to connect with the User\'s account on the Twitter social network, provided by Twitter, Inc.',
    ...
    'create-logged' => [
        ...
        'question1' => 'Question 1 risto',
        'question2' => 'Question 2 risto',
        'answer1' => 'Answer 1 risto',
        'answer2' => 'Answer 2 risto',
...
$def['create'] = $def;
$def['create']['already_registered'] = 'If you already have an account click here';
$def['create']['to_be_registered'] = 'If you are not registered yet, click here.';
$def['create']['prvPrivacy'] = 'Privacy';
$def['create']['mandatoryPrivacy'] = '* Selection required';
...
$def['create']['consCheckbox_0_title'] = 'Activity covered by the treatment';
$def['create']['consCheckbox_1_title'] = 'Remarketing activity';
$def['create']['consCheckbox_2_title'] = 'Site statistics activity';
$def['create']['consCheckbox_3_title'] = 'Social Network';

$def['create']['title_banner'] = 'Insert your restaurant, it\'s worth it!';
$def['create']['slogan_banner'] = 'Do you have a home delivery business? Register for the FoodTribù circuit!';
