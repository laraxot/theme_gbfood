		...
		<form class="row" method="GET" action="{{ asset($lang.'/restaurant_map') }}">
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="form-group">
					<input type="text" name="q" value="{{ \Request::input('q') }}" class="form-control" placeholder="@lang($trad.'.keyword') ">
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="form-group">
					<input type="text" name="cuisine_cat" class="form-control" placeholder="@lang($trad.'.cuisine_cat') ">
				</div>
			</div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="form-group">
					<select class="form-control" id="exampleSelect1">
						<option>@lang($trad.'.category')</option>
						<option>@lang($trad.'.fastfood')</option>
						<option>@lang($trad.'.pizza')</option>
						<option>@lang($trad.'.restaurant')</option>
					</select>
				</div>
			</div>
			--}}
			<div class="col-xs-12 col-md-6 col-lg-3">
				{{--
				<a href="food_results.html" class="btn theme-btn  btn-block" style="border-radius: 12px;">@lang($trad.'.invia')</a>
				--}}
