			...
			<div class="footer_logo">
				<a href="#">
					...
					<h5>@lang('pub_theme::footer.follow_me')</h5>
                            ...
                            <link itemprop="url" href="https://www.test sitename.com">
                                 <a href="{{ url('http://www.facebook.com/test sitenamecom') }}" class="btn btn-social-icon btn-facebook" target="_blank"><i class="fa fa-facebook"></i></a>
                                <!-- <a href="{{ url('http://www.twitter.com/FoodFriendFinde') }}" class="btn btn-social-icon btn-twitter" target="_blank"><i class="fa fa-twitter"></i></a>
                                 ...
                                 <a href="{{ url('https://www.instagram.com/test sitename') }}" class="btn btn-social-icon btn-instagram" target="_blank"><i class="fa fa-instagram"></i></a>
                                 <!--  <a href="{{ url('https://www.linkedin.com/company/test sitename/') }}" class="btn btn-social-icon btn-linkedin" target="_blank"><i class="fa fa-linkedin"></i></a><br/>
                                 <a href="{{ url('https://test sitename.tumblr.com/') }}" class="btn btn-social-icon btn-tumblr" target="_blank"><i class="fa fa-tumblr"></i></a>
                                 ...
                                 <a href="{{ url('https://myspace.com/test sitename') }}" class="btn btn-social-icon btn-user" target="_blank"><i class="fa fa-users"></i></a>
                                 <a href="{{ url('https://it.pinterest.com/test sitename/') }}" class="btn btn-social-icon btn-pinterest-p" target="_blank"><i class="fa fa-pinterest-p"></i></a>
                                 <a href="{{ url('https://soundcloud.com/test sitename') }}" class="btn btn-social-icon btn-soundcloud" target="_blank"><i class="fa fa-soundcloud"></i></a>-->
                                    </span>
				</div>
			{{--
