...
<div class="widget widget-cart">
    ...
    <table class="table">
        ...
        @foreach ($cart_items as $k => $cart_item)
            <tr>
                <td><b>{{ $cart_item->pivot->related->title }}</b> <a href="#"><i
                            class="fa fa-trash pull-right"></i></a></td>
    ...
    <div class="widget-body">
        <div class="price-wrap text-xs-center">
            <p>TOTAL</p>
            <h3 class="value"><strong>&euro; {{ money_format($restaurant_curr->cart_item_tot, 2) }}</strong>
            </h3>
            @php
                $parz = $params;
                $parz['container1'] = 'cart';
                $checkout_url = route('containers.create', $parz);
            @endphp
