            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc"
                    ...
                    <div class="pull-right" style="float:right;">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalAjax"
                            data-title="{{ $row->title }}"
                            data-href="{{ $restaurant_panel->url(['act' => 'edit']) }}">
                    ...
                    <div class="pull-left right-text white-txt">
                        ...
                        <a href="tel:{{ $restaurant_curr->phone }}" class="btn btn-green"><i
                                class="fa fa-phone"></i>{{ $restaurant_curr->phone }}</a>
