...
<div class="loginRes"></div>
    ...
    <ul class="dialog-alt-links">
        <li><a href="{{ asset('/login') }}" class="ajax-popup-link"  data-effect="mfp-zoom-out">@lang('pub_theme::auth.already_member')</a>
        </li>
        <li><a href="{{ asset('/register') }}" class="ajax-popup-link"  data-effect="mfp-zoom-out">@lang('pub_theme::auth.not_member_yet')</a>
        </li>
    </ul>
{{--    
</div>
